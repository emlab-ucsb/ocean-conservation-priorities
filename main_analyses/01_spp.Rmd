...
data.table::fwrite(bio_features_df, 
                   file.path(emLab_project_dir, "data", "02_processed", "features_df", "all_spp_distributions_df.csv"))
```
...
map_priorities(ranking_raster_se, discrete = T, mpas_raster = NULL, caption = "spp, scorched Earth", 
...
map_priorities(ranking_raster, discrete = T, mpas_raster = NULL, caption = "spp, with impacts", 
               ocean_df = ocean_matrix) +
