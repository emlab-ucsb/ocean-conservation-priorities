...
map_priorities(ranking_raster_a2, discrete = T, mpas_raster = MPAs, caption = "Multi-objective, equal weights, full effort displacement",
               ocean_df = ocean_matrix)+
...
map_priorities(ranking_raster_a2, discrete = T, mpas_raster = MPAs, caption = "Multi-objective, equal weights, full effort displacement",
               ocean_df = ocean_matrix)+
  ggsave(file.path(emLab_project_dir, "figures", "supplement", "multiobjective_priority_map_equal_weights_a2.png"),
         dpi = 300,  height = 4, width = 8)
```
