...
```{r}
save(bio_feature_names, z_bio, z_carbon, bio_weights, carbon_weights, food_weights, max_bio_delta, max_carbon_delta,
     Norm_features_matrix, protected_cells, stocks_info, stock_names, n_features, estimate_food_slopes_a1, estimate_delta_catch_a1,
     estimate_food_slopes_a2, estimate_delta_catch_a2, estimate_current_slopes, calculate_weights, max_food_delta_a1, max_food_delta_a2, MPAs_df,
...
while(nrow(unprotected_matrix) > 0){
    ...
    slopes <- estimate_current_slopes(x = current_state, g = group_ids, wts = multiobjective_feature_weigths_a1, food_model = "a1")
...
while(nrow(unprotected_matrix) > 0){
    ...
    slopes <- estimate_current_slopes(x = current_state, g = group_ids, wts = multiobjective_feature_weigths_a2, food_model = "a2")
