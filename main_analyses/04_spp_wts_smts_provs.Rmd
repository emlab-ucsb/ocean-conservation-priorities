...
map_priorities(ranking_raster_se, discrete = T, mpas_raster = NULL, caption = "spp + wts + smts + provs, scorched Earth", 
...
map_priorities(ranking_raster, discrete = T, mpas_raster = NULL, caption = "spp + wts + smts + provs, with impacts", 
               ocean_df = ocean_matrix) +
