...
```{r}
reviewed_fully_highly_protected_MPAs_raster_moll <- all_MPAs %>% 
...
```{r}
writeRaster(reviewed_fully_highly_protected_MPAs_raster_moll, 
            file.path(DIR_GCS,"masks/data/processed/fully_highly_protected_reviewed_MPAs.tif"),
            overwrite = T)

plot(reviewed_fully_highly_protected_MPAs_raster_moll)
```
...
writeRaster(territories_raster_lr, 
            file.path(emLab_project_dir, "data", "02_processed", "masks", "territories.tif"))
