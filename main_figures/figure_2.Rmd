...
ggsave(fig2, filename = file.path(emLab_project_dir, "figures", "main", "figure_2.pdf"), dpi = 300,  height = 8, width = 8)
ggsave(fig2, filename = file.path(emLab_project_dir, "figures", "main", "figure_2.png"), dpi = 300,  height = 8, width = 8)
```
