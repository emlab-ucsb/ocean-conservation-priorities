...
ggsave(fig_4, filename = file.path(emLab_project_dir, "figures", "main", "figure_4.png"), dpi = 300,  height = 11, width = 13)

ggsave(fig_4, filename = file.path(emLab_project_dir, "figures", "main", "figure_4.pdf"), dpi = 300,  height = 12, width = 11)
```
